...
const projects = [
  ...
  { id: 3, title: "ChronoGrid - Work-Time & Attendance Engine", description: "ChronoGrid is a modern full-stack timesheet system for tracking work hours, managing attendance, and generating real-time productivity insights. It features an interactive date grid, smart auto-fill scheduling, leave tracking, and seamless data import/export (PDF, Excel, CSV). Built with Next.js and Supabase, it supports both online syncing and offline local storage for uninterrupted usage.", tags: ["Next.js 14", "TypeScript", "Supabase", "Tailwind CSS", "SheetJS", "jsPDF", "Framer Motion", "Offline Support"], liveLink: "https://cronogrid-v2-0.vercel.app", codeLink: "https://github.com/harishd-dev/cronogrid-v2.0"},
